...
const timerHardware_t timerHardware[] = {
    // (jvi) Trying to change motor mapping by reordering the lines below in the structure.
    // The code that is commented out is the original code.  Flight controller is rotated 180 degrees
